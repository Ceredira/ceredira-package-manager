...
@Slf4j
class PackageManagerUninstallTest extends BaseTest {
    ...
    public void packageUninstall() {
        ...
        File destinationPackageResFolder = new File(String.valueOf(classRootPath),
        ...
        pm.uninstall("everything", "1.4.1.1028", "r1");
    }
}